...
import {
  ...
  sortNewArrivalsByDate,
} from "@/lib/newArrivalsData";
import styles from "./NewArrivals.module.css";
import { ArrowLeft, Eye, Heart, Shuffle, ShoppingCart } from "lucide-react";
...
const NewArrivals = () => {
  ...
  const arrivals = sortNewArrivalsByDate(newArrivalProducts).slice(0, 8);
